...
module OpenProject::GiteaIntegration
  class HookHandler
    ...
    def process(_hook, request, params, user)
      # TODO: check signature of gitea webhook and update the following lines
      event_type = request.env['HTTP_X_GITEA_EVENT']
      event_delivery = request.env['HTTP_X_GITEA_DELIVERY']
