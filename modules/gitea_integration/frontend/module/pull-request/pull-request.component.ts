...
import {
  IGiteaCheckRunResource,
  IGiteaPullRequest,
} from 'core-app/features/plugins/linked/openproject-gitea_integration/state/gitea-pull-request.model';

@Component({
  selector: 'op-gitea-pull-request',
...
export class PullRequestComponent {
  ...
  @Input() public pullRequest:IGiteaPullRequest;
  ...
  public text = {
    ...
    label_actions: this.I18n.t('js.gitea_integration.gitea_actions'),
  };
  ...
  public checkRunStateText(checkRun:IGiteaCheckRunResource) {
    /* Gitea apps can *optionally* add an output object (and a title) which is the most relevant information to display.
  ...
  public checkRunState(checkRun:IGiteaCheckRunResource) {
    return (checkRun.conclusion || checkRun.status);
  }

  public checkRunStateIcon(checkRun:IGiteaCheckRunResource) {
