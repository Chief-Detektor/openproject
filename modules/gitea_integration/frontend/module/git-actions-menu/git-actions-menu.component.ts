...
import { ISnippet } from 'core-app/features/plugins/linked/openproject-gitea_integration/state/gitea-pull-request.model';
...
export class GitActionsMenuComponent extends OPContextMenuComponent {
  ...
  public text = {
    title: this.I18n.t('js.gitea_integration.tab_header.git_actions.title'),
    copyButtonHelpText: this.I18n.t('js.gitea_integration.tab_header.git_actions.copy_button_help'),
    copyResult: {
      success: this.I18n.t('js.gitea_integration.tab_header.git_actions.copy_success'),
      error: this.I18n.t('js.gitea_integration.tab_header.git_actions.copy_error'),
    },
  };
  ...
  public snippets:ISnippet[] = [
    {
      id: 'branch',
      name: this.I18n.t('js.gitea_integration.tab_header.git_actions.branch_name'),
      textToCopy: () => this.gitActions.branchName(this.workPackage),
    },
    {
      id: 'message',
      name: this.I18n.t('js.gitea_integration.tab_header.git_actions.commit_message'),
      textToCopy: () => this.gitActions.commitMessage(this.workPackage),
    },
    {
      id: 'command',
      name: this.I18n.t('js.gitea_integration.tab_header.git_actions.cmd'),
