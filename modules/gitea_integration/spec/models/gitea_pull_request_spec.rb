...
RSpec.describe GiteaPullRequest do
  describe "validations" do
    it { is_expected.to validate_presence_of :gitea_html_url }
    it { is_expected.to validate_presence_of :number }
    it { is_expected.to validate_presence_of :repository }
    it { is_expected.to validate_presence_of :state }
    it { is_expected.to validate_presence_of :title }
    it { is_expected.to validate_presence_of :gitea_updated_at }
  ...
  describe '.without_work_package' do
    ...
    let(:pull_request) { create(:gitea_pull_request, work_packages:) }
    let(:work_packages) { [] }
...
#  describe '.find_by_gitea_identifiers' do
#    let(:gitea_id) { 5 }
#    let(:gitea_url) { 'https://gitea.com/opf/openproject/pull/123' }
#    let(:pull_request) do
#      create(:gitea_pull_request,
#             gitea_id:,
#             gitea_html_url: gitea_url)
#    end
#
#    context 'when the gitea_id attribute matches' do
#      it 'finds by gitea_id' do
#        expect(described_class.find_by_gitea_identifiers(id: pull_request.gitea_id))
#          .to eql pull_request
#      end
#    end
#
#    context 'when the gitea_html_url attribute matches' do
#      it 'finds by gitea_html_url' do
#        expect(described_class.find_by_gitea_identifiers(url: pull_request.gitea_html_url))
#          .to eql pull_request
#      end
#    end
#
#    context 'when the provided gitea_id does not match' do
#      it 'is nil' do
#        expect(described_class.find_by_gitea_identifiers(id: pull_request.gitea_id + 1))
#          .to be_nil
#      end
#    end
#
#    context 'when the provided gitea_html_url does not match' do
#      it 'is nil' do
#        expect(described_class.find_by_gitea_identifiers(url: "#{pull_request.gitea_html_url}zzzz"))
#          .to be_nil
#      end
#    end
#
...
#      it 'is nil' do
#        expect(described_class.find_by_gitea_identifiers(id: pull_request.gitea_id + 1,
#                                                          url: "#{pull_request.gitea_html_url}zzzz"))
#          .to be_nil
#      end
#    end
#
#    context 'when the provided gitea_html_url does not match but the gitea_id does' do
#      it 'is nil' do
#        expect(described_class.find_by_gitea_identifiers(id: pull_request.gitea_id,
#                                                          url: "#{pull_request.gitea_html_url}zzzz"))
#          .to eql pull_request
...
#    end
#
#    context 'when the provided gitea_html_url does match but the gitea_id does not' do
#      it 'is nil' do
#        expect(described_class.find_by_gitea_identifiers(id: pull_request.gitea_id + 1,
#                                                          url: pull_request.gitea_html_url))
#          .to eql pull_request
#      end
#    end
#
...
#      subject(:finder) do
#        described_class.find_by_gitea_identifiers(id: pull_request.gitea_id + 1,
#                                                   url: "#{pull_request.gitea_html_url}zzzz",
#                                                   initialize: true)
#      end
#
...
#          .to eql("gitea_id" => pull_request.gitea_id + 1,
#                  "gitea_html_url" => "#{pull_request.gitea_html_url}zzzz")
#      end
#    end
#  end
  ...
  describe '#latest_check_runs' do
    ...
    let(:pull_request) { create(:gitea_pull_request) }
      ...
      let(:latest_check_runs) do
        [
          create(
            ...
            gitea_pull_request: pull_request
          ),
          create(
            :gitea_check_run,
            app_id: 123,
